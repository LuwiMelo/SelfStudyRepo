...
if($_POST['YearFrom'] == $_POST['YearTo']){
    ...
    $StudentIDQuery = " AND LEFT(StudentIDDisplay,4) = ".$_POST['YearFrom'];
}
else{
    $StudentIDQuery = " AND LEFT(StudentIDDisplay,4) BETWEEN ".$_POST['YearFrom']." AND ".$_POST['YearTo'];
}
