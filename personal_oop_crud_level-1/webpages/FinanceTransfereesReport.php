...
WHERE
	 tblstudent.StudentID = tblstudentadmission.AdmissionStudentID AND tblstudentadmission.AdmissionSchoolYearID = $LatestSchoolYearID AND  tblmunicipality.MunicipalityID = tblstudent.StudentMunicipalityID AND tblgradelevel.GradeLevelID = tblstudentadmission.AdmissionGradeLevelID  AND AdmissionStatus = 2 AND tblprovince.ProvinceID = tblstudent.StudentProvinceID AND `AdmissionAssessmentIDDisplay` IS NOT NULL
...
<div id="content-header">
 ...
 <div class="container-fluid">
          ...
          <hr>
 <center><h1>Transferees Data Report </h1></center>
