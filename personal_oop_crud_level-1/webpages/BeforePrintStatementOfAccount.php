...
$StudentID = $_SESSION['GenerateSOAStudentIDPass'];
/*
try
{
    $LatestSchoolYear;
    $statement = $dbh->prepare("SELECT AdmissionStudentID FROM tblstudentadmission WHERE AdmissionID = $AdmissionID");
    $statement->execute();
    $row = $statement->fetch();
...
try
{
    ...
    $statement->execute(array(':AdmissionStudentID' => $StudentID, ':AdmissionID' => $AdmissionID  ));
...
<!--Action boxes-->
  <div class="container-fluid">
    ...
    <center>    <img  style="width: 800px; height: 150px;" src="phase1logo.png"> </center>
      <br>
 <center><h1> Generate Statement of Account  </h1></center>
      <br>
      <br>
...
catch (PDOException $e)
{
 ...
 <div class="row-fluid">
     ...
     <div class="span1"></div>
        ...
        <div class="span5 control-group" id="AmountDueControlGroup">
              
                   <label class="control-label">*Amount Due</label>
              <div class="controls">
                <input type="text" name="AmountDue" id="AmountDue" class="span10 m-wrap" placeholder="e.g. 10000.50"/>
                   <span class="help-inline" style="color: #b94a48; display: none;" id="AmountDueError"  name="AmountDueError">Please enter a valid amount</span> 
              </div>
    ...
    <div class="row-fluid">
         ...
         <a class="btn btn-info btn-large pull-right" href="CheckSOAList.php" style="margin-right: 50px;">Back</a>
                  
        <button id="btnGenerateSOA" class="btn btn-primary btn-large pull-right" type="button" style = " margin-right: 30px;" >Generate SOA</button>
  ...
  $( document ).ready(function() {
    ...
    */
    ...
    function formatDate(date) {
      ...
      $("#btnGenerateSOA").click(function(e){
        if (confirm('Save all changes?')) {
            ...
            if(isNaN(AmountDue) || AmountDue == null || AmountDue == ""){
                FormValidator = false;
                $("#AmountDueControlGroup").addClass("error");
                $("#AmountDueError").show();
            }
            else{
               $("#AmountDueControlGroup").removeClass("error");
               $("#AmountDueError").hide();
            }
            
   
        
            var PaymentDetails = { DueDateInsert: DueDateInsert, ModeOfPayment: ModeOfPayment, AmountDue: AmountDue };
            ...
            if(FormValidator){
                   $.ajax({
                            type:'POST',
                            url:'GenerateSOAUpdateDueDate.php',
                            ...
                            success:function(html){
                               ...
                               //window.location.href="/iucsenrollmentsystem/webpages/SucceedingPaymentSuccessMessage.php";
                                ...
                                var win = window.open('/iucsenrollmentsystem/webpages/PrintStatementOfAccount.php', '_blank');
                                if (win) {
