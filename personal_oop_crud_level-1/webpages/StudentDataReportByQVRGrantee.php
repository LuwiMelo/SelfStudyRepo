     ...
     <div class="row-fluid">
         <div class="span12">
             <div class="widget-box">
              ...
              <li class="active"><a data-toggle="tab" href="#tab6">By QVR Grantee</a></li>
...
<div id="tab6" class="tab-pane active">
    ...
    <form action="QVRAlphabeticalReport.php" method="post">
             <!-- Row 1 -->
             <div class="row-fluid">
                 <div class="span3"></div>
        ...
        <br>
             ...
             <div class="row-fluid">
                ...
                <div class="span3" style="margin-left: -30px;">
                   <label class="control-label">*From QVR</label>
              
                 <div class="controls">
                <select name="ESCQVR" id="ESCQVR">
                   <option value="0">With QVR Private</option>
                   <option value="1">With QVR Public</option>
                   <option value="2">With QVR Public or Private</option>
                   <option value="3">With No QVR</option>
