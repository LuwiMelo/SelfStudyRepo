...
<!--Action boxes-->
  <div class="container-fluid">
    ...
    <center>    <img  style="width: 800px; height: 150px;" src="phase1logo.png"> </center>
      <br>
 <center><h1>Enrollment - Phase 1 (For Transferees) </h1></center>
      <br>
      <br>
...
catch (PDOException $e)
{
    echo "There is some problem in connection: " . $e->getMessage();
              ...
              <div class="controls">
                <div id="BirthdayDiv" data-date="12-02-2012" class="input-append date datepicker">
                  <input type="text" name="Birthday" id="Birthday" data-date-format="mm-dd-yyyy" class="span11 birthdaydatepicker" >
        ...
        if (confirm('Enroll this student data?')) {
          ...
          var AddressPrefix = $("#AddressPrefix").val();
            ...
            if(FormValidator){
                   $.ajax({
                            type:'POST',
                            url:'Phase1Submit.php',
                            data:{"RetrieveTransaction" : JSON.stringify(StudentDetails)},
                            success:function(html){
                                 
                                   window.location.href="/iucsenrollmentsystem/webpages/Phase1SuccessMessage.php";
