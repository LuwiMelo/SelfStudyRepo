      ...
      <br>
          ...
          <div class="widget-content">
            ...
            <div class="alert alert-success alert-block"> <a class="close" data-dismiss="alert" href="#">×</a>
              <center><h1 class="alert-heading">Enrollment Phase 1 (Re-enrollees/Old Student) Success!</h1></center>
                
            <h3>
              You have completed the phase 1 of enrollment in Imus Unida Christian School. For the final phase of enrollment, please go to the Registrar's Office! 
