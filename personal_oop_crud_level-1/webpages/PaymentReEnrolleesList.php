...
$DataTableQuery = "SELECT GradeLevel, StudentID,AdmissionReenrollmentID,CONCAT(LastName,' ',FirstName,' ',COALESCE(MiddleName,'')) AS 'Fullname' FROM tblstudent,tblstudentadmission 
LEFT JOIN tblgradelevel ON tblstudentadmission.AdmissionGradeLevelId = tblgradelevel.GradeLevelID WHERE AdmissionStudentID = StudentID  AND StudentStatus = 0 AND LEFT(AdmissionReenrollmentID,4) = $LatestSchoolYear and ADMISSIONSTATUS = 1 AND AdmissionID NOT IN(SELECT PaymentAdmissionID from tblpaymenttransactions WHERE PaymentSchoolYearID = $LatestSchoolYearID) GROUP BY StudentID ORDER BY AdmissionReenrollmentID ASC";
?>
...
<div id="content-header">
 ...
 <div class="container-fluid">
          ...
          <hr>
 <center><h1>List of Re-Enrollees with No Initial Payment</h1></center>
