...
try
{
    ...
    if (!empty($row)) {
            ...
            foreach($row as $dataa){
               ...
               $OutputData .= '["'.$dataa['ReligionID'].'","'.$dataa['ReligionName'].'","<button class=\"btn btn-success btnEditReligion\" data-id=\"'.$dataa['ReligionID'].'\" data-name=\"'.$dataa['ReligionName'].'\"  >Edit</button>","<button disabled class=\"btn btn-danger btnDeleteReligion\" data-id=\"'.$dataa['ReligionID'].'\" data-name=\"'.$dataa['ReligionName'].'\"    >Delete</button>"],';
                //echo $OutputData;
            }
