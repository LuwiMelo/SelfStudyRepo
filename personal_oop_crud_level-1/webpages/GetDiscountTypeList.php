...
try
{
    ...
    $statement = $dbh->prepare("SELECT * FROM tbldiscounttype WHERE DiscountTypeDiscountCategoryID = :DiscountType");
    $statement->execute(array(':DiscountType' => $_POST["country_id"]));
