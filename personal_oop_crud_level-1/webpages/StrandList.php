...
<div id="content-header">
 ...
 <center><h1>Strand Maintenance 
     ...
     <div class="row-fluid">
         ...
         <button class="btn btn-primary" id="btnAddNewReligion">Add New Strand</button>
...
<div id="AddNewReligionModal" class="modal hide">
              ...
              <label class="control-label">*Strand ID(System Generated) :</label>
              <div class="controls">
            ...
            <label class="control-label">*Strand :</label>
              <div class="controls">
                <input type="text" name="ReligionNameAdd" id="ReligionNameAdd" class="span4" placeholder="e.g. STEM - Science, Technology, Engineering and Mathematics" />
...
<div id="EditReligionModal" class="modal hide">
            ...
            <label class="control-label">*Strand :</label>
              <div class="controls">
                <input type="text" name="ReligionNameEdit" id="ReligionNameEdit" class="span4" placeholder="e.g. STEM - Science, Technology, Engineering and Mathematics" />
                <span class="help-inline" style="color: #b94a48; display: none;" id="ReligionNameEditError"  name="ReligionNameEditError">Invalid Religion</span>
              </div>
     ...
     <div id="DeleteReligionModal" class="modal hide">
              <div class="modal-header">
                <button data-dismiss="modal" class="close" type="button">×</button>
                <h3>Warning! Delete Strand</h3>
              </div>
              <div class="modal-body" style="">

                <h4>Are you sure you want to delete this strand? All students registered with this strand will be updated to Strand not set</h4>
...
//Data Table Initialization
    ...
    var oTable2 = $('#StudentRecordsList').dataTable({
                          ...
                          //"bServerSide": true, //Removing bServerSide fix the problem. I don't know why.
                            ...
                            "sAjaxSource": "StrandLoadData.php",
...
$("#AddReligionSaveChanges").click(function(e){
     ...
     var AddReligionDetails = { StrandID: AddID, StrandName: AddReligionName };
     
             $.ajax({
                    type:'POST',
                    url:'AddStrandSaveChanges.php',
                    async: false,
                    ...
                    success:function(data){
                         ...
                         //Manual Code for Refresh Data Table using Ajax
                          $.getJSON("StrandLoadData.php", null, function( json ){
                                table = $("#StudentRecordsList").dataTable();
...
$("#EditSaveChanges").click(function(e){
     ...
     var EditReligionDetails = { StrandID: EditID, StrandName: EditReligionName };
     
             $.ajax({
                    type:'POST',
                    url:' EditStrandSaveChanges.php',
                    async: false,
...
$("#DeleteReligionSaveChanges").click(function(e){
            ...
            var DeleteReligionDetails = { StrandID: DeleteReligionID};
    
          $.ajax({
                    type:'POST',
                    url:' DeleteStrandSaveChanges.php',
                    async: false,
