...
LEFT JOIN tblgradelevel ON tblstudentadmission.AdmissionGradeLevelId = tblgradelevel.GradeLevelID WHERE AdmissionStudentID = StudentID AND AdmissionSchoolYearID = $LatestSchoolYearID  GROUP BY StudentID ORDER BY Fullname ASC";
?>
...
try
{
    ...
    foreach($row as $data){
        ...
        echo '<td>'.$data['GradeLevel'].'</td>';
          ...
          echo " <td> <form action=\"FinancialCertificateInitializer.php\" method=\"post\"><input class=\"btn btn-primary\" type=\"submit\" value=\"Generate Financial Cert\" > <input type=\"hidden\" name=\"id\" value=\"".$data["StudentID"]."\">
