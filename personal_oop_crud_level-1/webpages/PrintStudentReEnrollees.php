...
$AdmissionIDRetrieve = $_SESSION['VSReenrolleeAdmissionID'];
...
$StudentID = $_SESSION['VSReenrolleeStudentID'];
$AdmissionIDRetrieve = $_SESSION['VSReenrolleeAdmissionID'];
          ...
          foreach($row as $data){
            ...
            //  $RetrieveReferenceNumber = $data['AdmissionReferenceNum'];
             // $_SESSION['EditStudentSelectedReferenceNum'] = $RetrieveReferenceNumber;
              ...
              $_SESSION['EditStudentReenrolleeAdmissionID'] = $data['AdmissionID'];
...
try
{
    ...
    $statement->execute(array(':SiblingMainStudentID' => $StudentID, ':SiblingTableAdmissionID' => $_SESSION['EditStudentReenrolleeAdmissionID'] ));
    $row = $statement->fetchAll();
...
<!--Action boxes-->
  <div class="container-fluid">
    ...
    <center>    <img  style="width: 800px; height: 150px;" src="phase1logo.png"> </center>
      <br>
 <center><h1>Student Record for Re-enrollees</h1></center>
      <br>
      <br>
...
catch (PDOException $e)
{
    echo "There is some problem in connection: " . $e->getMessage();
     ...
     ?>
             ...
             <div class="control-group" id="StudentNumControlGroup">
              <label class="control-label">*Student Number:</label>
              <div class="controls">
                <input type="text" class="span11" name="StudentIDDisplay" id="StudentIDDisplay" placeholder="457848457744" value="<?php echo $RetrieveStudentIDDisplay; ?>" />
                <span class="help-inline" style="color: #b94a48; display: none;" id="StudentNumError"  name="StudentNumError">Invalid Student Number </span> 
              </div>
            </div>
...
catch (PDOException $e)
{
    echo "There is some problem in connection: " . $e->getMessage();
              ...
              <div class="controls">
                <input type="text" name="Age" id="Age" class="span11" placeholder="Age"  value="" />
...
-->
      ...
      <div class="row-fluid">
            ...
            <div class="span1" style="margin-right: -28px;"></div>
            <div class="span5">
            ...
            <div class="span5" name="DivStrand" id="StrandControlGroup">
...
catch (PDOException $e)
{
    echo "There is some problem in connection: " . $e->getMessage();
        ...
        <button type="button" id="SubmitButton" class="btn btn-large btn-success">Update Information</button> 
             ...
             <a href="ReEnrolleesList.php"><button type="button"  id="CancelButton" class="btn btn-large btn-danger">Cancel</button></a>
    ...
    $("#SubmitButton").click(function(e){
        if (confirm('Update student data?')) {
          ...
          var AddressPrefix = $("#AddressPrefix").val();
            ...
            var StudentIDDisplay = $("#StudentIDDisplay").val();
            ...
            if(FormValidator){
                   $.ajax({
                            type:'POST',
                            url:'EditStudentReenrolleeSubmit.php',
                            data:{"RetrieveTransaction" : JSON.stringify(StudentDetails)},
                            success:function(html){
                                 
                                    window.location.href="/iucsenrollmentsystem/webpages/ReEnrolleesList.php";
