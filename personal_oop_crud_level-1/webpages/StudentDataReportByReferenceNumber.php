...
<div id="content-header">
     ...
     <div class="row-fluid">
         <div class="span12">
             <div class="widget-box">
              ...
              <li class="active"><a data-toggle="tab" href="#tab1">By Reference Number</a></li>
            </ul>
 ...
 <div class="widget-content tab-content">
    ...
    <div id="tab1" class="tab-pane active">
         ...
         <form action="ByReferenceNumberReport.php" method="post">
             <!-- Row 1 -->
             <div class="row-fluid">
                 <div class="span3"></div>
...
<?php 
             try
{
    $statement = $dbh->prepare("SELECT * FROM tblschoolyear ORDER BY SchoolYearID ASC ");
    $statement->execute();
    $row = $statement->fetchAll();
    ...
    if (!empty($row)) {
        ...
        foreach($row as $data){
           ...
           echo '<option value ="' . $data['SchoolYear'] . '" '. $selected .'>' . $data['SchoolYear'] . '</option>';
