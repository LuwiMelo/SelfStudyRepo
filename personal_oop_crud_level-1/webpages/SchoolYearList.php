...
<div id="content-header">
 ...
 <div class="container-fluid">
          ...
          <hr>
 <center><h1>School Year Maintenance 
     </h1></center>
     ...
     <div class="row-fluid">
         ...
         <button class="btn btn-primary" id="btnAddNewNationality">Add New School Year</button>
...
<div id="AddNewNationalityModal" class="modal hide">
              ...
              <label class="control-label">*School Year ID(System Generated) :</label>
              <div class="controls">
            ...
            <label class="control-label">*School Year :</label>
              <div class="controls">
                <input type="text" name="NationalityNameAdd" id="NationalityNameAdd" class="span4" placeholder="e.g. 2019" />
...
<div id="EditNationalityModal" class="modal hide">
              ...
              <label class="control-label">*School Year ID :</label>
              <div class="controls">
     ...
     <div id="DeleteNationalityModal" class="modal hide">
              ...
              <div class="modal-footer"> <a id="DeleteNationalitySaveChangesss"  data-dismiss="modal" class="btn btn-danger" href="#">Confirm</a> <a data-dismiss="modal" class="btn" href="#">Cancel</a> </div>
</div>
...
//Data Table Initialization
    ...
    var oTable2 = $('#StudentRecordsList').dataTable({
                          ...
                          //"bServerSide": true, //Removing bServerSide fix the problem. I don't know why.
                            ...
                            "sAjaxSource": "SchoolYearLoadData.php",
...
$("#AddNationalitySaveChanges").click(function(e){
     ...
     var AddNationalityDetails = { SchoolYearID: AddID, SchoolYear: AddNationalityName };
     
             $.ajax({
                    type:'POST',
                    url:'AddSchoolYearSaveChanges.php',
                    async: false,
                    ...
                    success:function(data){
                         ...
                         //Manual Code for Refresh Data Table using Ajax
                          $.getJSON("SchoolYearLoadData.php", null, function( json ){
                                table = $("#StudentRecordsList").dataTable();
...
$("#EditSaveChanges").click(function(e){
     ...
     var EditNationalityDetails = { SchoolYearID: EditID, SchoolYear: EditNationalityName };
     
             $.ajax({
                    type:'POST',
                    url:' EditSchoolYearSaveChanges.php',
                    async: false,
                    data:{"RetrieveTransaction" : JSON.stringify(EditNationalityDetails)},
                    success:function(data){
