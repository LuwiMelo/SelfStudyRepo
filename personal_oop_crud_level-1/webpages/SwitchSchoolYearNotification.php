...
*/
 $CurrentSchoolYear = $_SESSION['SessionSelectedSchoolYear'];
 $CurrentSchoolYearPlusOne = $CurrentSchoolYear + 1;
      ...
      <br>
          ...
          <div class="widget-content">
            ...
            <div class="alert alert-success alert-block"> <a class="close" data-dismiss="alert" href="#">×</a>
              <center><h1 class="alert-heading">Switch School Year</h1></center>
                
            <h3>
               You are now viewing School Year <?php echo  $_SESSION['SessionSelectedSchoolYear']; ?> - <?php echo $CurrentSchoolYearPlusOne; ?>
