...
if($_POST['ESCQVR'] == 0){
    ...
    $ESCQVRQuery = " AND QVRDiscount = 47 ";
}

if($_POST['ESCQVR'] == 1){
    
    $ESCQVRQuery = " AND QVRDiscount = 46 ";
}

if($_POST['ESCQVR'] == 2){
    
    $ESCQVRQuery = " AND QVRDiscount BETWEEN 46 AND 47 ";
}

if($_POST['ESCQVR'] == 3){
    
    $ESCQVRQuery = " AND (QVRDiscount NOT IN (46,47) OR QVRDiscount IS NULL) ";
    //$ESCQVRQuery = "";
}
