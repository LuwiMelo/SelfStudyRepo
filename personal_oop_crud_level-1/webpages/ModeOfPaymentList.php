...
<div id="content-header">
 ...
 <div class="container-fluid">
          ...
          <hr>
 <center><h1>Mode of Payment Maintenance 
     </h1></center>
     ...
     <div class="row-fluid">
         ...
         <div class="span9"></div>
         <button class="btn btn-primary" id="btnAddNewReligion" style="margin-left: 60px;">Add New Mode of Payment</button>
...
<div id="AddNewReligionModal" class="modal hide">
              <div class="modal-header">
                ...
                <h3>Add New Mode of Payment</h3>
              </div>
              <div class="modal-body" style="margin-left: 80px;">

         
              <label class="control-label">*Mode of Payment ID(System Generated) :</label>
              <div class="controls">
            ...
            <label class="control-label">*Mode of Payment :</label>
              <div class="controls">
                <input type="text" name="ReligionNameAdd" id="ReligionNameAdd" class="span4" placeholder="e.g. 001-Cash Basis" />
...
<div id="EditReligionModal" class="modal hide">
              <div class="modal-header">
                <button data-dismiss="modal" class="close" type="button">×</button>
                <h3>Edit Mode of Payment</h3>
              </div>
              <div class="modal-body" style="margin-left: 80px;">

         
              <label class="control-label">*Mode of Payment ID :</label>
              <div class="controls">
            ...
            <label class="control-label">*Mode of Payment :</label>
              <div class="controls">
                <input type="text" name="ReligionNameEdit" id="ReligionNameEdit" class="span4" placeholder="e.g. 001-Cash Basis" />
                <span class="help-inline" style="color: #b94a48; display: none;" id="ReligionNameEditError"  name="ReligionNameEditError">Invalid Religion</span>
              </div>
     ...
     <div id="DeleteReligionModal" class="modal hide">
              <div class="modal-header">
                <button data-dismiss="modal" class="close" type="button">×</button>
                <h3>Warning! Delete Mode of Payment</h3>
              </div>
              <div class="modal-body" style="">

                <h4>Are you sure you want to delete this mode of payment? All students registered with this mode of payment will be updated to Mode of Payment not set</h4>
...
//Data Table Initialization
    ...
    var oTable2 = $('#StudentRecordsList').dataTable({
                          ...
                          //"bServerSide": true, //Removing bServerSide fix the problem. I don't know why.
                            ...
                            "sAjaxSource": "ModeOfPaymentLoadData.php",
...
$("#btnAddNewReligion").click(function(e){
     let NewReligionID;
         ...
         $.ajax({
                    type:'GET',
                    url:'GetLatestModeOfPaymentID.php',
                    async: false,
...
$("#AddReligionSaveChanges").click(function(e){
     ...
     var AddReligionDetails = { PaymentOptionID: AddID, PaymentOptionName: AddReligionName };
     
             $.ajax({
                    type:'POST',
                    url:'AddModeOfPaymentSaveChanges.php',
                    async: false,
                    ...
                    success:function(data){
                         ...
                         //Manual Code for Refresh Data Table using Ajax
                          $.getJSON("ModeOfPaymentLoadData.php", null, function( json ){
                                table = $("#StudentRecordsList").dataTable();
...
$("#EditSaveChanges").click(function(e){
     ...
     var EditReligionDetails = { PaymentOptionID: EditID, PaymentOptionName: EditReligionName };
     
             $.ajax({
                    type:'POST',
                    url:'EditPaymentOptionSaveChanges.php',
                    async: false,
...
$("#DeleteReligionSaveChanges").click(function(e){
            ...
            var DeleteReligionDetails = { PaymentOptionID: DeleteReligionID};
    
          $.ajax({
                    type:'POST',
                    url:' DeleteModeOfPaymentSaveChanges.php',
                    async: false,
