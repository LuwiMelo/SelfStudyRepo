...
<div id="content-header">
 ...
 <center><h1>Section Maintenance 
     ...
     <div class="row-fluid">
         ...
         <button class="btn btn-primary" id="btnAddNewReligion">Add New Section</button>
...
<div id="AddNewReligionModal" class="modal hide">
              ...
              <label class="control-label">*Section ID(System Generated) :</label>
              <div class="controls">
                <input type="text" name="ReligionIDAdd" id="ReligionIDAdd" class="span4" placeholder="Religion ID" disabled/>
                <span class="help-inline" style="color: #b94a48; display: none;" id="ReligionIDEditError"  name="ReligionIDEditError">Invalid Section ID</span>
              </div>

              
            <label class="control-label">*Section :</label>
              <div class="controls">
                <input type="text" name="ReligionNameAdd" id="ReligionNameAdd" class="span4" placeholder="e.g. 029-G11 Compassion" />
                <span class="help-inline" style="color: #b94a48; display: none;" id="ReligionNameEditError"  name="ReligionNameEditError">Invalid Section</span>
              </div>
...
<div id="EditReligionModal" class="modal hide">
            ...
            <label class="control-label">*Section :</label>
              <div class="controls">
                <input type="text" name="ReligionNameEdit" id="ReligionNameEdit" class="span4" placeholder="e.g. 029-G11 Compassion " />
                <span class="help-inline" style="color: #b94a48; display: none;" id="ReligionNameEditError"  name="ReligionNameEditError">Invalid Section</span>
              </div>
              ...
              <select name="GradeLevelEdit" id="GradeLevelEdit">
                  <option value="0">Grade Level not set</option>
                     <?php 
...
try
{
    ...
    if (!empty($row)) {
        ...
        foreach($row as $data){
            ...
            if($_SESSION['SelectedSectionGradeLevelEdit'] == $data['GradeLevelID']){
                $selected1 = "selected";
...
catch (PDOException $e)
{
    echo "There is some problem in connection: " . $e->getMessage();
     ...
     <div id="DeleteReligionModal" class="modal hide">
              <div class="modal-header">
                <button data-dismiss="modal" class="close" type="button">×</button>
                <h3>Warning! Delete Section</h3>
              </div>
              <div class="modal-body" style="">

                <h4>Are you sure you want to delete this section? All students registered with this section will be updated to Section not set</h4>
              ...
              <div class="modal-footer"> <a id="DeleteReligionSaveChanges" data-id="" data-name="" data-dismiss="modal" class="btn btn-danger" href="#">Confirm</a> <a data-dismiss="modal" class="btn" href="#">Cancel</a> </div>
</div>
...
//Data Table Initialization
    ...
    var oTable2 = $('#StudentRecordsList').dataTable({
                          ...
                          //"bServerSide": true, //Removing bServerSide fix the problem. I don't know why.
                            ...
                            "sAjaxSource": "SectionLoadData.php",
...
$('#StudentRecordsList').on('click', '.btnEditReligion', function(){
            ...
            var SectionDetails = { SectionID: ReligionID };
            
       //alert(ReligionID);
    
       $.ajax({
                    type:'POST',
                    url:'GetGradeLevelEditSection.php',
                    async: false,
...
$("#AddReligionSaveChanges").click(function(e){
     ...
     var AddReligionDetails = { SectionID: AddID, SectionName: AddReligionName, SectionGradeLevel: AddSectionGradeLevel };
     
             $.ajax({
                    type:'POST',
                    url:'AddSectionSaveChanges.php',
                    async: false,
                    ...
                    success:function(data){
                         ...
                         //Manual Code for Refresh Data Table using Ajax
                          $.getJSON("SectionLoadData.php", null, function( json ){
                                table = $("#StudentRecordsList").dataTable();
...
$("#EditSaveChanges").click(function(e){
     ...
     var EditReligionDetails = { SectionID: EditID, SectionName: EditReligionName, SectionGradeLevel: EditSectionGradeLevel };
     
 
             $.ajax({
                    type:'POST',
                    url:' EditSectionSaveChanges.php',
                    async: false,
...
$("#DeleteReligionSaveChanges").click(function(e){
            ...
            var DeleteReligionDetails = { SectionID: DeleteSectionID };
     
    
          $.ajax({
                    type:'POST',
                    url:' DeleteSectionSaveChanges.php',
                    async: false,
